...
//   const [itemNb] = React.useState(10);
...
//   return (
//     <Box sx={{ width: '70%', margin: '100px', border: '4px'}}>
//       <BarChart
//         height={400}
//         width={1200}
//         borderRadius={100}
//         series={series
//           .slice(0, seriesNb)
//           .map((s) => ({ ...s, data: s.data.slice(6, itemNb) }))}
//       />
...
const Sales = () => {
  ...
  const series = [
    {
      label: 'This year',
      data: [2423, 2362, 1145, 2361, 968, 2316, 2140, 1074, 1792, 1433],
    },
    {
      label: 'Last year',
      data: [2210, 2254, 1214, 979, 1371, 1845, 2082, 744, 886, 1161],
    },
  ];

  return (
    <Box sx={{ width: '100%', margin: '100px' }}>
      <BarChart
        borderRadius={100}
        height={400}
        width={1200}
        ...
        xAxis={[{ 
          data: months.slice(0, itemNb),
          scaleType: 'band',
        }]}
        yAxis={[{ max: 3000 }]}
        colors={['#35a2eb', '#99caff']}
      />
    </Box>
  );
}
